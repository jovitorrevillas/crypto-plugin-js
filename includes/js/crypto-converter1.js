! function(t) {
    ICConverter = function() {
        function t(t) {
            ...
            e.innerText = '.ibx-button-background{background: linear-gradient(to right, #3d208e , #a017d9); clip-path: polygon(0% 0%, 0% 100%, 0% 100%, 85% 75%, 100% 0%, 50% 0%);} a.ibx-button-background{color: white; text-decoration: none;}#WIDGET .ibx-dropdown{position:relative}#WIDGET .ibx-dropdown .ibx-dropdown__button{display:block;text-decoration:none;color:#4794ee;font-size:12px;font-weight:600;line-height:16px;text-align:center;position:relative;padding:20px 5px;text-transform:uppercase;-webkit-transition:all 350ms;transition:all 350ms}#WIDGET .ibx-dropdown .ibx-dropdown__button::before{content:\'\';width:16px;height:16px;display:block;position:absolute;background-image:url(data:image/svg+xml;base64,);top:50%;margin-top:-8px;right:10px;-webkit-transition:all 350ms;transition:all 350ms}#WIDGET .ibx-dropdown .ibx-dropdown__button:hover{color:#5287cb}#WIDGET .ibx-dropdown .ibx-dropdown__button:hover::before{margin-top:-7px;opacity:.7}#WIDGET .ibx-dropdown .ibx-dropdown__list{list-style:none;padding:0;margin:25px 0 0;position:absolute;left:-1px;top:100%;min-width:100%;visibility:hidden;opacity:0;background:#fff;border:1px solid #afbdc4;z-index:100;-webkit-box-shadow:0 2px 4px 0 rgba(0,0,0,.2);box-shadow:0 2px 4px 0 rgba(0,0,0,.2);border-radius:2px;-webkit-transition:all 350ms;transition:all 350ms}#WIDGET .ibx-dropdown .ibx-dropdown__list-item{text-align:center;text-transform:uppercase;display:block;text-decoration:none;color:#4794ee;font-size:12px;font-weight:600;padding:6px 8px;cursor:pointer;margin-left: 0 !important;}#WIDGET .ibx-dropdown .ibx-dropdown__list-item:hover{color:#000;background:#e6e6e6}#WIDGET .ibx-dropdown.ibx-dropdown_open .ibx-dropdown__button::before{-webkit-transform:rotate(180deg);transform:rotate(180deg)}#WIDGET .ibx-dropdown.ibx-dropdown_open .ibx-dropdown__list{visibility:visible;opacity:1;margin-top:0}#WIDGET .ibx-calc{padding:20px;text-align:center;font-family:"Roboto",Verdana,"Helvetica Neue",Tahoma,Arial,sans-serif;border-radius:2px;}#WIDGET .ibx-calc .ibx-calc__title{color:#010101;font-size:18px;font-weight:600;line-height:24px}#WIDGET .ibx-calc .ibx-calc__form{margin:0 auto 0;}#WIDGET .ibx-calc .ibx-calc__group-fields:focus-within{border: 0px solid #afbdc4;}#WIDGET .ibx-calc .ibx-calc__group-fields{max-width:370px;border-radius:1px;background-color:#fff;margin: 15px 15px 15px;font-size:0;padding-right:96px;-webkit-box-shadow: 0px 11px 29px -11px rgba(0,0,0,0.3);-moz-box-shadow: 0px 11px 29px -11px rgba(0,0,0,0.3);box-shadow: 0px 11px 29px -11px rgba(0,0,0,0.3);}#WIDGET .ibx-calc .ibx-calc__control-text{color:#4794ee;font-size:16px;width:100%;display:block;vertical-align:top;line-height:14px;padding:20px 8px;border:0;background:#fff;outline:0;-webkit-box-sizing:border-box;box-sizing:border-box;font-family:"Roboto",Verdana,"Helvetica Neue",Tahoma,Arial,sans-serif}#WIDGET .ibx-calc .ibx-calc__control-text::-moz-placeholder{color:#afbdc4;opacity:1}#WIDGET .ibx-calc .ibx-calc__control-text:-ms-input-placeholder{color:#afbdc4}#WIDGET .ibx-calc .ibx-calc__control-text::-webkit-input-placeholder{color:#afbdc4}#WIDGET .ibx-calc .ibx-calc__dropdown{width:95px;height:32px;background-color:#fff;display:block;float:right;margin-right:-96px;vertical-align:top}#WIDGET .ibx-calc .ibx-calc__button{margin-top:15px;}#WIDGET .ibx-calc #WIDGET .ibx-calc .ibx-calc__button:hover{-webkit-box-shadow:0 3px 6px 0 rgba(0,0,0,.31);box-shadow:0 3px 6px 0 rgba(0,0,0,.31);background-color:#313f47}#WIDGET .ibx-calc .ibx-calc__button:active{-webkit-box-shadow:0 1px 6px 0 rgba(0,0,0,.31);box-shadow:0 1px 6px 0 rgba(0,0,0,.31);background-color:#4c626e}.style-2 .ibx-dropdown{position:relative;background:#f7931a}.style-2 .ibx-dropdown__button:hover{color:#fff}.style-2 .ibx-dropdown__button{color:#fff !important;box-shadow:none !important}.style-2 .ibx-dropdown__list-item{color:#f7931a !important;margin-left:0 !important}.style-2 .ibx-dropdown__list-item:hover{color:#000 !important}.style-2 .ibx-calc__control-text{color:#000 !important;padding:19px 8px !important;border:1px solid goldenrod !important}.style-3 .ibx-dropdown{position:relative;box-shadow:0 2px 2px #7e7e7e}.style-3 .ibx-dropdown__button:hover{color:#fff}.style-3 .ibx-dropdown__button{background:linear-gradient(to bottom right,#ab1a23,#ab1a23)!important}.style-3 .ibx-dropdown__list{background:#2a2a2a!important}.style-3 .ibx-dropdown__list-item{color:#f7931a!important;margin-left:0!important}.style-3 .ibx-dropdown__list-item:hover{color:#000!important}.style-3 .ibx-calc__control-text{background:#2a2a2a!important;box-shadow:0 2px 2px #7e7e7e}'.replace(/(#WIDGET)+/g, "#" + t + " "), document.getElementsByTagName("body")[0].appendChild(e)
        }! function(t, e) {
            "use strict";
            ...
            function e(t, e, n, r) {
                var s = ["then", "catch", "always"].reduce(function(t, e) {
                    ...
                    D = o(e, n, t);
                return N.open(t, D, !0), N.withCredentials = r.hasOwnProperty("withCredentials"), i(N, r.headers), N.addEventListener("readystatechange", M(s, N), !1), N.send(c(n)), s.abort = function() {
                    return N.abort()
                }, s
            }
            ...
            return function(o) {
                ...
                return o = o || {}, o.baseUrl = o.baseUrl || "", o.method && o.url ? e(o.method, o.baseUrl + o.url, t(o.data), o) : i.reduce(function(i, n) {
        ...
        var o = function(t) {
                ...
                var o = '<li data-symbol="{symbol}" class="ibx-dropdown__list-item">{value}</li>',
                    i = {
                ...
                for (var r in this.options.currencies) M.push(e.nano(o, {
                    ...
                    var theme = selectedStyle;
                    var theme_ibinex = '';
                    switch (theme) {
                        case 'theme-1':
                          theme_ibinex  =  '<div id="style-1" class="d-flex row justify-content-around align-items-center">'+
                        '<div class="ibx-calc__group-fields col-md-5">' +
                            '<div class="ibx-calc__dropdown">' +
                                '<div id="{_prefix}IC_WIDGET_CONVERTER_DROPDOWN_CURRENCIES" class="js-dropdown ibx-dropdown"><a href="javascript:;" class="ibx-dropdown__button">{currency_default}</a>' +
                                    '<ul class="ibx-dropdown__list">{currencies}</ul>' +
                                '</div>' +
                            '</div>' +
                        ...
                        '<div class="ibx-calc__group-fields col-md-5">' +
                            '<div class="ibx-calc__dropdown">' +
                                '<div id="{_prefix}IC_WIDGET_CONVERTER_DROPDOWN_COINS" class="js-dropdown ibx-dropdown"><a href="#" class="ibx-dropdown__button">{coin_default}</a>' +
                                    '<ul class="ibx-dropdown__list">{coins}</ul>' +
                                '</div>' +
                            '</div>' +
                    ...
                    '</div>';
                        ...
                        case 'theme-2':
                            theme_ibinex  =  '<div class="style-2 d-flex row justify-content-around align-items-center">'+
                        '<div class="ibx-calc__group-fields col-md-6">' +
                            '<div class="ibx-calc__dropdown">' +
                                '<div id="{_prefix}IC_WIDGET_CONVERTER_DROPDOWN_CURRENCIES" class="js-dropdown ibx-dropdown"><a href="javascript:;" class="ibx-dropdown__button">{currency_default}</a>' +
                                    '<ul class="ibx-dropdown__list">{currencies}</ul>' +
                                '</div>' +
                    ...
                    '</div>';
                        ...
                        case 'theme-3':
                            theme_ibinex  =  '<div id="style-3" class="d-flex row justify-content-around align-items-center">'+
                        '<h3 class="d-flex row justify-content-around align-items-center"></h3>'+
                        '<div class="ibx-calc__group-fields col-md-5">' +
                            '<div class="ibx-calc__dropdown">' +
                                '<div id="{_prefix}IC_WIDGET_CONVERTER_DROPDOWN_CURRENCIES" class="js-dropdown ibx-dropdown"><a href="javascript:;" class="ibx-dropdown__button">{currency_default}</a>' +
                                    '<ul class="ibx-dropdown__list">{currencies}</ul>' +
                                '</div>' +
                            '</div>' +
                            '<input class="ibx-calc__control-text" type="text" id="{_prefix}IC_WIDGET_CONVERTER_AMOUNT_1" />' +
                            '<input type="hidden" value="{currency_default}" id="{_prefix}IC_WIDGET_CONVERTER_CURRENCY" />' +
                        '</div>' +
                        '<div class="ibx-calc__group-fields col-md-5">' +
                            '<div class="ibx-calc__dropdown">' +
                                ...
                                '</div>' +
                            '</div>' +
                            '<input class="ibx-calc__control-text" type="text" id="{_prefix}IC_WIDGET_CONVERTER_AMOUNT_2" />' +
                            '<input value="{coin_default}" type="hidden" id="{_prefix}IC_WIDGET_CONVERTER_COIN" />' +
                        '</div>'+
                    '</div>';
                        break;
            ...
            i = function(t, o) {
                this._template = "", this._data = {}, this.fnItemsTemplatePrepare = function() {}, this.controls = {}, this.container = t, this._defaults = {
                    data: {},
                    prefix: ""
        ...
        i.prototype.init = function() {
            ...
            this.controls.AMOUNT = document.getElementById(this.options.prefix + "IC_WIDGET_CONVERTER_AMOUNT_1"), this.controls.CURRENCY = document.getElementById(this.options.prefix + "IC_WIDGET_CONVERTER_CURRENCY"), this.controls.DROPDOWN_CURRENCIES = document.getElementById(this.options.prefix + "IC_WIDGET_CONVERTER_DROPDOWN_CURRENCIES"), this.controls.AMOUNT_COINS = document.getElementById(this.options.prefix + "IC_WIDGET_CONVERTER_AMOUNT_2"), this.controls.COIN = document.getElementById(this.options.prefix + "IC_WIDGET_CONVERTER_COIN"), this.controls.DROPDOWN_COINS = document.getElementById(this.options.prefix + "IC_WIDGET_CONVERTER_DROPDOWN_COINS"), this.controls.AMOUNT.addEventListener("keyup", this.calculateFromAmount.bind(this)), this.controls.AMOUNT_COINS.addEventListener("keyup", this.calculateFromCoins.bind(this)), this.controls.DROPDOWN_COINS.addEventListener("click", this.dropdownController.bind(this)), this.controls.DROPDOWN_CURRENCIES.addEventListener("click", this.dropdownController.bind(this)), document.addEventListener("click", function(t) {
                e.closest(t.target, "#" + this.controls.DROPDOWN_COINS.id) || e.hasClass(this.controls.DROPDOWN_COINS, "ibx-dropdown_open") && (console.log("hide DROPDOWN_COINS"), this.controls.DROPDOWN_COINS.classList.remove("ibx-dropdown_open")), e.closest(t.target, "#" + this.controls.DROPDOWN_CURRENCIES.id) || e.hasClass(this.controls.DROPDOWN_CURRENCIES, "ibx-dropdown_open") && (console.log("hide DROPDOWN_CURRENCIES"), this.controls.DROPDOWN_CURRENCIES.classList.remove("ibx-dropdown_open"))
            }.bind(this))
        }, i.prototype.dropdownController = function(t) {
            t.preventDefault(), e.hasClass(t.target, "ibx-dropdown__button") ? this.dropdownToggle(t) : e.hasClass(t.target, "ibx-dropdown__list-item") && this.dropdownChange(t)
        }, i.prototype.dropdownToggle = function(t) {
            t.returnValue = !1, t.target.parentNode.classList.toggle("ibx-dropdown_open")
        }, i.prototype.dropdownChange = function(t) {
            var o = e.closest(t.target, ".ibx-dropdown");
            if(this.controls.DROPDOWN_COINS.firstChild.innerText == t.target.getAttribute("data-symbol") || this.controls.DROPDOWN_CURRENCIES.firstChild.innerText == t.target.getAttribute("data-symbol")){}
                ...
                o.querySelector(".ibx-dropdown__button").textContent = t.target.getAttribute("data-symbol"), o.id === this.controls.DROPDOWN_COINS.id ? (this.controls.COIN.value = t.target.getAttribute("data-symbol"), this.calculateFromCoins()) : o.id === this.controls.DROPDOWN_CURRENCIES.id && (this.controls.CURRENCY.value = t.target.getAttribute("data-symbol"), this.calculateFromAmount()), o.classList.toggle("ibx-dropdown_open")
            }
    ...
    var selectedStyle = n.getAttribute("style-selected") ? n.getAttribute("style-selected") : null
